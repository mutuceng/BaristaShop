using BaristaShop.DtoLayer.Dtos.CatalogDtos.VariantDtos;
using BaristaShop.DtoLayer.Dtos.CatalogDtos.VariantOptionDtos;
...
namespace BaristaShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class VariantController : Controller
    {
        ...
        public VariantController(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<IActionResult> CreateCategoryFeature()
        {
            ...
            //    var values = JsonConvert.DeserializeObject<List<ResultVariantOptionDto>>(jsonData);
        ...
        [HttpPost]
        [Route("CreateCategoryFeature")]
        public async Task<IActionResult> CreateCategoryFeature(CreateVariantDto model)
        {
            //ViewBag.v0 = "Kategori Özellik İşlemleri";
            //ViewBag.v1 = "Kategori Özellik Ekleme";
            ...
            //    var createCategoryFeatureDto = new CreateVariantDto
            //    {
