...
{
    public class EfShipmentOperationDal : GenericRepository<ShipmentOperation>, IShipmentOperationDal
    {
        public EfShipmentOperationDal(CargoContext context) : base(context)
        {
        }
    }
}
